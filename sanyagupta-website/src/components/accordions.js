...
const Accordions = () => {
  ...
  const sections = [
    ...
    { title: 'My Background', content: 'I have experience in multitude of coding languages: Python, Java, HTML, CSS, JavaScript, React.js. I have configured cisco switches from basic configurations to configuring the IP addresses and VLANs. I have developed coding projects: a Game Hub website with multiple games, this personal website, Rock, Paper, Scissors GUI in Python, Mutiple ML Projects as well! Feel free to look at my GitHub for more info ;)' },
